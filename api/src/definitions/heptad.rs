...
impl Heptad {
    ...
    /// Get user expression by index (0-6)
    /// 
...
mod tests {
    ...
    fn test_trait_compliance() {
        ...
        assert_eq!(heptad.user_expressions().len(), 7);
